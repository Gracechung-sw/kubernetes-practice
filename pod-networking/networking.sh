...
# 경과가 아래와 같이 출력됨. 
# (base) grace@jeonghyeonjeong-ui-MacBookPro pod-networking % kubectl get pod -o wide
# (base) grace@jeonghyeonjeong-ui-MacBookPro pod-networking % kubectl get pod -o wide
# NAME             READY   STATUS    RESTARTS   AGE   IP           NODE       NOMINATED NODE   READINESS GATES
# blue-green-app   2/2     Running   0          45s   172.17.0.6   minikube   <none>           <none>
# red-app          1/1     Running   0          37s   172.17.0.7   minikube   <none>           <none>
